...
if ($this->isAddInstitutionApp()) {
	// Translate title in header
        $this->data['header'] = $this->t('add_institution');
...
if ($this->isOriginalSpNonFilteringIdPs()) {
	echo 'Can\'t find your institution? Contact us at <a href="mailto:idm@ics.muni.cz?subject=Request%20for%20adding%20new%20IdP">idm@ics.muni.cz</a>';
        ...
        echo 'Can\'t find your institution? Select it in extended list and help us <a class="btn btn-primary" href="https://idm.ics.muni.cz/add-institution-ceitec/">add your institution</a>';
}
echo '</div>';
