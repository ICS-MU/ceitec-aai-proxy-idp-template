...
$this->data['head'] .= '<link rel="stylesheet" media="screen" type="text/css" href="' . SimpleSAML\Module::getModuleUrl('ceitec/res/css/disco.css')  . '" />';
...
try {
	...
	SimpleSAML\Logger::warning("ceitec:disco-tpl: missing or invalid config-warning file");
}
...
if ($config != null) {
	try {
		...
		SimpleSAML\Logger::warning("ceitec:disco-tpl: missing or invalid isOn parameter in config-warning file");
		$warningIsOn = false;
	}
}
...
if ($warningIsOn) {
	try {
		...
		SimpleSAML\Logger::warning("ceitec:disco-tpl: missing or invalid userCanContinue parameter in config-warning file");
	...
	try {
		...
		SimpleSAML\Logger::warning("ceitec:disco-tpl: missing or invalid title or text in config-warning file");
		$warningIsOn = false;
	}
}
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 col-md-offset-2">
                <div class="metalist list-group">
                    <a class="btn btn-block social" href="<?php echo $this->getContinueUrl('https://idp2.ics.muni.cz/idp/shibboleth');?>" style="background: #002776">
            ...
            <div class="col-md-4">
                <div class="metalist list-group">
                    <a class="btn btn-block social" href="<?php echo $this->getContinueUrl('https://www.vutbr.cz/SSO/saml2/idp'); ?>" style="background: #e4002b">
...
if (!$warningIsOn || $warningUserCanContinue) {
    ...
    echo '	<form id="idpselectform" action="?" method="get">
			<input class="inlinesearchf form-control input-lg" placeholder="' . $this->t('{ceitec:ceitec:name_of_institution}') . '" 
