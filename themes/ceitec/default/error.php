...
?>
 <a href="#moreInfo" data-toggle="collapse"> <?php echo $this->t('{ceitec:ceitec:more}');?> <span class="caret"></span></a>
...
<div id="moreInfo" class="collapse">
	<p id="trackid" class="input-left"><?php echo $this->t('{ceitec:ceitec:error_number}'); echo $this->data['error']['trackId']; ?></p>
<?php
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="reportId"><?php echo $this->t('{ceitec:ceitec:error_id}'); ?></label>
		<div class="col-sm-10">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<span  class="help-block"><?php echo $this->t('{ceitec:ceitec:error_report_email_message}');?></span>
		</div>
	</div>
