...
$this->data['head'] .= '<script src="' . Module::getModuleUrl('ceitec/res/js/jquery.js') . '" ></script>';
$this->data['head'] .= '<script src="' . Module::getModuleUrl('ceitec/res/bootstrap/js/bootstrap.min.js') .
    '" ></script>';
...
?>
    ...
    <p>
        ...
        ?>
        <a href="#moreInfo" data-toggle="collapse"> <?php echo $this->t('{ceitec:ceitec:more}'); ?>
...
?>
    <div id="moreInfo" class="collapse">
        <p id="trackid" class="input-left"><?php echo $this->t('{ceitec:ceitec:error_number}');
            ...
            <form action="<?php echo htmlspecialchars($this->data['errorReportAddress']); ?>" method="post"
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"
                           for="reportId"><?php echo $this->t('{ceitec:ceitec:error_id}'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="help-block">
                            <?php echo $this->t('{ceitec:ceitec:error_report_email_message}'); ?>
                        </span>
                    </div>
                </div>
