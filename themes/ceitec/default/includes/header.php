...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo Module::getModuleUrl('ceitec/res/bootstrap/css/bootstrap.min.css'); ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo Module::getModuleUrl('ceitec/res/css/ceitec.css'); ?>"/>
...
<div id="wrap">
    ...
    <div id="header">
        <img src="<?php echo Module::getModuleUrl('ceitec/res/img/logo_512.png'); ?>" alt="CEITEC logo">
        <h1>
            <?php
