...
<body onload="document.getElementsByTagName('input')[0].click();">
	...
	<noscript>
		<p><strong><?php echo $this->t('{ceitec:ceitec:note}'); ?></strong><?php echo $this->t('{ceitec:ceitec:browser_not_support_javascript}'); ?></p>
	</noscript> 
...
?>
		...
		<noscript>
			<button type="submit" class="btn"><?php echo $this->t('{ceitec:ceitec:submit}'); ?></button>
		</noscript>
	</form>
